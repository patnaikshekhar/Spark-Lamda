...
public final class SparkLambda {
     ...
     */
    public static void get(String route, RouteLambda lambda) {

        // Create a new Spark route.
        Spark.get(new Route(route) {
            @Override
            public Object handle(Request request, Response response) {
                return lambda.handle(request, response);
            }
        });
    }
     ...
     * @param lambda The lambda expression to handle the route
     */
    public static void post(String route, RouteLambda lambda) {
     ...
     * @param lambda The lambda expression to handle the route
     */
    public static void put(String route, RouteLambda lambda) {
     ...
     * @param lambda The lambda expression to handle the route
     */
    public static void delete(String route, RouteLambda lambda) {
     ...
     * @param lambda The lambda expression to handle the route
     */
    public static void options(String route, RouteLambda lambda) {
     ...
     * @param lambda The lambda expression to handle the route
     */
    public static void head(String route, RouteLambda lambda) {
     ...
     * @param lambda The lambda expression to handle the route
     */
    public static void patch(String route, RouteLambda lambda) {
